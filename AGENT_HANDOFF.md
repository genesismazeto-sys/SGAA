...
## Current state — PHASE 4-B5-P CLOSED / ACCEPTED
...
The former pre-publication state of this unit (NEVER CLOSED / ACCEPTED; technical commit/push/review PENDING; `INDEPENDENT_REVIEW_PENDING`) is phase-time history only. It is preserved as the audit trail and is superseded by the accepted current state above. The RED/GREEN chronology, B5-P-R1 fixed-baseline classification, B5-P-R2 supplemental scope authorization and all routing/fallback history remain preserved under the accepted state block.
