...
from app.views.admin.requisicoes import bp_admin_requisicoes
from app.views.admin.versioning import bp_admin_versioning
from app.views.admin.matrizes import bp_admin_matrizes
from app.views.admin.alunos_turmas_cursos import bp_admin_alunos_turmas_cursos
from app.views.admin.banco_dados import bp_admin_banco_dados
from app.views.admin.acesso import bp_admin_acesso
from app.views.admin.arquivos import bp_admin_arquivos
...
def create_app(
    *,
    ...
    register_admin_requisicoes_blueprint: bool = True,
    register_admin_matrizes_blueprint: bool = True,
    register_admin_alunos_turmas_cursos_blueprint: bool = True,
    register_admin_banco_dados_blueprint: bool = True,
    register_admin_acesso_blueprint: bool = True,
    register_admin_arquivos_blueprint: bool = True,
    ...
    register_admin_demo_blueprint: bool = True,
) -> Flask:
    ...
    if register_admin_versioning_blueprint:
        register_legacy_blueprint(app, bp_admin_versioning)
    if register_admin_requisicoes_blueprint:
        register_legacy_blueprint(app, bp_admin_requisicoes)
    if register_admin_matrizes_blueprint:
        register_legacy_blueprint(app, bp_admin_matrizes)
    if register_admin_alunos_turmas_cursos_blueprint:
        register_legacy_blueprint(app, bp_admin_alunos_turmas_cursos)
    if register_admin_banco_dados_blueprint:
        register_legacy_blueprint(app, bp_admin_banco_dados)
    if register_admin_acesso_blueprint:
        register_legacy_blueprint(app, bp_admin_acesso)
    if register_admin_arquivos_blueprint:
        register_legacy_blueprint(app, bp_admin_arquivos)
    if register_admin_alertas_blueprint:
        register_legacy_blueprint(app, bp_admin_alertas)
    if register_admin_reportes_blueprint:
    ...
    if register_admin_demo_blueprint:
        register_legacy_blueprint(app, bp_admin_demo)
