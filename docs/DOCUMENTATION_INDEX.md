...
`docs/refactor/PHASE4_MATRIZES_BLUEPRINT_CONTRACT.md` for PHASE 4-B5
      ...
      PHASE 4-B6 (Alunos/Turmas/Cursos admin blueprint; IMPLEMENTED / AWAITING
      SUPERVISOR REVIEW; exact 17 endpoints / 24 route-method pairs / 10 helpers;
      exact R1 three-dead-context exception; not CLOSED / ACCEPTED).
...
8. `docs/refactor/PHASE4_ATIVIDADES_BLUEPRINT_CONTRACT.md` — accepted B3 exact
 ...
 14. `docs/refactor/PHASE4_ALUNOS_TURMAS_CURSOS_BLUEPRINT_CONTRACT.md` — current
      PHASE 4-B6 candidate contract; IMPLEMENTED / AWAITING SUPERVISOR REVIEW;
      exact 17 endpoints / 24 route-method pairs / 10 helpers; full hermetic GREEN;
      B6 is not CLOSED / ACCEPTED.
 15. `PROJECT_STATE.md` — canonical current state (top block).
 16. `docs/refactor/HISTORICAL_DATABASE_SNAPSHOT_CUSTODY.md` — historical snapshot custody governance track.
 17. `AGENT_HANDOFF.md` — current operational handoff.
 18. All `docs/refactor/REF_*.md` / `docs/refactor/PHASE_0_*.md` files in dependency order: REF-0TF →
...
| `PHASE4_ALUNOS_TURMAS_CURSOS_BLUEPRINT_CONTRACT.md` | PHASE 4-B6 | IMPLEMENTED / AWAITING SUPERVISOR REVIEW at parent/live feature `cab4c61bdf7a1eef361a80f426dda558b11e9201`; exact 17 endpoints / 24 route-method pairs / 10 helpers; main 27 identity re-exports and zero local B6 bodies; RBAC 6/13/5; B6-P owners preserved; R1 exactly three dead `periodo_corrente` context removals while the function remains main-local; zero `app -> main`; CSRF B6 11 owner-only and exact historical partitions 19/24; final full 1095 passed / 17 deselected / 0 failed/errors / 433.87s / canonical opens 0; exact 16-path candidate ceiling; technical commit and publication pending. |
