...
`docs/refactor/PHASE4_MATRIZES_BLUEPRINT_CONTRACT.md` for PHASE 4-B5
      ...
      IMPLEMENTED / AWAITING SUPERVISOR REVIEW; exact 4 shared symbols,
...
8. `docs/refactor/PHASE4_ATIVIDADES_BLUEPRINT_CONTRACT.md` — accepted B3 exact
 ...
 15. `docs/refactor/PHASE4_ARQUIVOS_ALERTAS_SHARED_OWNER_CONTRACT.md` — PHASE 4-B7-P
      Arquivos/Alertas neutral shared-owner prerequisite contract; IMPLEMENTED /
      AWAITING SUPERVISOR REVIEW; exact 4 shared symbols moved to neutral
      owners 2/1/1 (`app.db_maintenance`, `app.admin_files` new,
