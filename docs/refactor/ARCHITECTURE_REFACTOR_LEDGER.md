...
| PHASE4-B4.2 | Move the exact Admin Requisições route cohort to its canonical blueprint while preserving global legacy endpoint identities and consuming accepted neutral owners | IMPLEMENTED / LOCALLY VERIFIED / INDEPENDENTLY_REVIEWED / AWAITING_SUPERVISOR_REVIEW | Candidate from baseline `c587098152e97d125f41a2d26f2f414c10ae5676`; exact 16 paths (3 production, 7 tests/snapshots, 6 governance); candidate identity to be resolved by Git publication | Authorized execution; external supervisor acceptance remains outstanding | TDD RED 20 failed / 3 passed; focused GREEN lanes 138 + 107 passed; final hermetic 1005 passed / 17 deselected after recovering four stale governance assertions; exact 9 endpoints / 12 route-method pairs; RBAC 4 view / 5 edit / 3 full; routes 131; endpoints 130; governed pairs 134; unmapped 0; actor 402 = 263 + 139; message catalog 536; CSRF exactly five owner-only deltas per snapshot. Technical review Flash FREE `ses_03ff5695bffeEBNIZRiSVZonYz`, cost 0, no fallback/mutation: PASS / blocking NONE / scope EXACT / behavior PRESERVED / governance COHERENT; nonblocking hash-method finding corrected in contract. | `docs/refactor/PHASE4_REQUISICOES_BLUEPRINT_CONTRACT.md` | No redesign authorized; Matrizes, Phase 5 and Phase 6 not authorized; migration v4 prohibited; Phase 4 not closed. |
| Fase 4 | Admin blueprint extraction | OPEN / INCREMENTAL IMPLEMENTATION / B1-B3 CLOSED / ACCEPTED / B4-A CLOSED / ACCEPTED / B4.1 CLOSED / ACCEPTED / B4.2 IMPLEMENTED / INDEPENDENTLY REVIEWED / AWAITING SUPERVISOR REVIEW | B1 `cd8a76b2484abc376174332578ecd8be4b8206ea`; B2 `17e468ad938e873e1f9e9c303808ad31b9f3806b`; B3 `50801b6bdddc4d2772853c13f4905c49e8c996cf`; B4.1 `73ebf0dc34681e74e778759af476e1cd2f981444`; B4.2 candidate unpublished | N/A | B1/B2/B3/B4-A/B4.1 accepted evidence preserved; B4.2 local implementation, full hermetic qualification and independent review complete; publication pending | `docs/mapeamento/05_avaliacao_refactor.md`; Phase 4 B1/B2/B3/B4.1/B4.2 contracts | Later cohorts unauthorized; `dashboard.py` and `admin_meus_dados` ownership unresolved; migration v4 prohibited; Phase 4 not closed. |
