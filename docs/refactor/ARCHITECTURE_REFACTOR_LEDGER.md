...
| PHASE4-B4.1 | Extract neutral Requisições shared owners, reconcile all-eight B1 settings ownership and establish dedicated matrix-scope ownership without moving routes or hardening behavior | IMPLEMENTED / AWAITING SUPERVISOR REVIEW | Subject `Extract requisition shared owners`; parent `185426daccc9f0eb0dba4497248100c1a88d15fa`; exact 20 paths (7 production, 7 tests, 6 governance) | External supervisor review pending | Baseline 125; TDD RED 7/1; governance RED 1; owner GREEN 8; affected lane 247; first full 981/3/17, recovered nodes 3; final full 984/17/419.95s; AST equivalence PASS; message catalog 536; canonical SQLite opens 0. Review `flash_free`, effective `opencode/deepseek-v4-flash-free`, session `ses_040d538bfffegBsAJQbLJrnqSV`, cost 0, hash `f4b6cb00b4365cc7c20af5fcba1ac736ece1bab0ab9c6e0f89b19084799727f9`, no fallback/mutation, PASS / findings NONE. | `docs/refactor/PHASE4_REQUISICOES_SHARED_OWNER_CONTRACT.md` | `B4_1_SCOPE_EXPANSION / COHERENT_NEUTRALIZATION / SUPERVISOR_RECONCILED`: B1-time Configurações owner becomes B4.1-time `app.settings`; B2-time six Aluno lazy edges become five by removing only matrix scope; Phase-3 test delta is governance-reader-only. NO ROUTE MOVEMENT; nine Requisições handlers remain in `main.py`; B4.2 unauthorized. |
| Fase 4 | Admin blueprint extraction | OPEN / INCREMENTAL IMPLEMENTATION / B1-B3 CLOSED / ACCEPTED / B4-A CLOSED / ACCEPTED / B4.1 IMPLEMENTED / AWAITING SUPERVISOR REVIEW | B1 `cd8a76b2484abc376174332578ecd8be4b8206ea`; B2 `17e468ad938e873e1f9e9c303808ad31b9f3806b`; B3 `50801b6bdddc4d2772853c13f4905c49e8c996cf`; B4.1 subject `Extract requisition shared owners` | N/A | B1/B2/B3/B4-A accepted evidence preserved; B4.1 exact reconciled shared-owner cut and no-route proof recorded | `docs/mapeamento/05_avaliacao_refactor.md`; Phase 4 B1/B2/B3/B4.1 contracts | B4.2 and later cohorts unauthorized; `dashboard.py` and `admin_meus_dados` ownership unresolved; migration v4 prohibited; Phase 4 not closed. |
