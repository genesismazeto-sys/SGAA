...
| Fase 1 | Safe cleanup: dead code, lixo, headers | OPEN / IN PROGRESS | N/A | N/A | U1 CLOSED / ACCEPTED; U2 CLOSED / ACCEPTED; U3 NOT STARTED / REQUIRES SEPARATE ORDER | `docs/mapeamento/05_avaliacao_refactor.md` | Only U1 and U2 accepted at this time; U3 not started; no other cleanup unit authorized |
...
- **EXACTLY ONE CURRENT NEXT TECHNICAL ACTION:** PHASE-1-U3 — focused read-only proof of the legacy/no-op aluno route bodies and `aluno_runtime_route`. U3 is NOT STARTED / REQUIRES SEPARATE ORDER and not authorized for mutation.
