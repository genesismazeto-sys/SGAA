...
| PHASE4-B3 | Extract exactly 22 Atividades and versioned-catalog legacy endpoints / 29 route-method pairs; establish neutral `app.activity_catalog` and `app.uploads` ownership; reconcile message and CSRF owner metadata without moving Matrizes/Requisições routes | IMPLEMENTED / AWAITING SUPERVISOR REVIEW | Authorized subject `Extract admin activities blueprint`; parent expected `81cc6b10b893f1d34bd211a527e9fd12c3b6bbbe`; exact 16-path candidate ceiling | Technical review PASS; selective publication and post-publication proof pending at commit-tree time | B3 contract 19; affected lane 353 in 119.56s; historical pre-final-test-delta 974/17/292.86s; final hermetic 974 passed / 17 deselected / 399.95s / exit 0; routes 131; endpoints 130; governed pairs 134; RBAC unmapped 0; actor matrix 402 = 263 allowed + 139 denied. Provisional FREE session `ses_0425bf1cbffeIxMwsDQn0etSEC`, cost 0: UNUSABLE / NO VERDICT. Final FREE session `ses_0422f0e1cffepCXyNpg47dWpoq`, cost 0: TIMEOUT. Accepted `opencode-go/deepseek-v4-flash` session `ses_04224ca47ffe5qAwwHGtxlR7i7`, router cost 0.0010424344 USD, diff `ec96796d3541710a36ac8121e40ffd888737c7c926f191a28034482cedbfd556`, mutation 0, PASS, findings NONE. IAsup: hash concern REJECTED_INCORRECT; no-test limit ACCEPTED_NONBLOCKING. Non-governance hash `13b0af13e653641d75d2466d7d8d69090e655a18e28bb678a7090dbe0e2ecab0`. | `docs/refactor/PHASE4_ATIVIDADES_BLUEPRINT_CONTRACT.md` | B3-R1 scope expansion reconciled exactly, not generically authorized. Message 536→536; CSRF 15 owner-only deltas each. Global legacy endpoints and `main` identity exports retained. B4, Phase 5/6 unauthorized; migration v4 prohibited; Phase 4 not closed. |
| Fase 4 | Admin blueprint extraction | OPEN / INCREMENTAL IMPLEMENTATION / B1-B2 CLOSED / ACCEPTED / B3 IMPLEMENTED / AWAITING SUPERVISOR REVIEW | B1 `cd8a76b2484abc376174332578ecd8be4b8206ea`; B2 `17e468ad938e873e1f9e9c303808ad31b9f3806b`; B3 authorized subject `Extract admin activities blueprint` | N/A | B1/B2 accepted evidence preserved; B3 final hermetic 974/17/399.95s and technical review PASS; documentary addendum/publication pending | `docs/mapeamento/05_avaliacao_refactor.md`; Phase 4 B1/B2/B3 contracts | Later cohorts, Phase 5/6 unauthorized; `dashboard.py` and `admin_meus_dados` ownership unresolved; migration v4 prohibited; Phase 4 not closed. |
