...
| Fase 1 | Safe cleanup: dead code, lixo, headers | OPEN / IN PROGRESS | N/A | N/A | U1 CLOSED / ACCEPTED; U2 CLOSED / ACCEPTED; U3 CLOSED / ACCEPTED; U4 NOT STARTED / REQUIRES SEPARATE ORDER | `docs/mapeamento/05_avaliacao_refactor.md` | U1, U2 and U3 accepted; U4 read-only only; no other cleanup unit authorized |
