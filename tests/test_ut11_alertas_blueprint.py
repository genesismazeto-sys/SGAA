...
def test_red_l_message_scanner_auto_covers_target_without_registration():
    ...
    assert_catalog_matches_canonical_baseline(catalog, context="UT-11 RED L")
...
def test_green_5_message_catalog_canonical_and_views_recursive_scanner_coverage():
    ...
    assert_catalog_matches_canonical_baseline(
        messages._message_catalog(), context="UT-11 GREEN 5"
    )
